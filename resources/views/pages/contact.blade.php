            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    <div id="map" class="map">
                        @php
                            $apiKey = config('services.google_maps.api_key'); // Assuming you store your API key in a config file
                        @endphp
                        ...
                        <script>
                            function loadGoogleMaps() {
                                ...
                                script.src =
                                    `https://maps.googleapis.com/maps/api/js?key=${encodeURIComponent('{{ $apiKey }}')}&callback=initMap`;
                                script.async = true;
                                script.defer = true;
